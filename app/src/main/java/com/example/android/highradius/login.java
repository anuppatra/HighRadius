...
public class login extends AppCompatActivity {
    ...
    /**
     * Initializing the components needed for log management

     */
    private void initFirebase() {
        //
        //Initialize components to login, register
        ...
        //Keeps dialog waiting while you're typing
    ...
    /*public void trylogin(View view){
        ...
        startActivity(new Intent(login.this, GroupFragment.class));
        login.this.finish();
    }*/

    /**
     *
     Reasons for choosing the right product for your business, ...
     */
    class AuthUtils {
        /**
         * Action register
        ...
        /**
         * Saving information for login and creating firebase user node.
         */
        void saveUserInfo() {
        ...
        /**
         * Initialize the default information for the new account
         */
